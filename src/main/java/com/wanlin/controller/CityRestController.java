...
public class CityRestController {
    ...
    public List<City> findCityListMap(@RequestParam Map<String, Object> param) throws Exception {
    	List<City> res = null;
        String cityName = param.get("cityName") + "";

        if("wanlin2".equals(cityName)){
        	throw new Exception("wanlin2");
        }
        res =  cityService.findCityByName(param);
        return res;
    }
}
